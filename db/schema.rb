...
ActiveRecord::Schema.define(version: 20181205163635) do
  ...
  create_table "contas", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["descricao"], name: "index_contas_on_descricao", unique: true, using: :btree
    t.index ["fornecedor_id"], name: "index_contas_on_fornecedor_id", using: :btree
  end
  ...
  add_foreign_key "contas", "fornecedores"
end
