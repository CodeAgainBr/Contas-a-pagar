...
class ContasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conta" do
    assert_difference('Conta.count') do
      post contas_url, params: { conta: { descricao: @conta.descricao, despesa: @conta.despesa, fornecedor_id: @conta.fornecedor_id, valor: @conta.valor, vencimento: @conta.vencimento } }
    end
  ...
  test "should update conta" do
    patch conta_url(@conta), params: { conta: { descricao: @conta.descricao, despesa: @conta.despesa, fornecedor_id: @conta.fornecedor_id, valor: @conta.valor, vencimento: @conta.vencimento } }
